...
var universities = {
  'sk': ['uploads/universities/ncfu.png', 'uploads/universities/agrar.jpeg', 'uploads/universities/pgu.png', 'uploads/universities/kgti.png'],
  'dagestan': ['uploads/universities/narxoz.png', 'uploads/universities/dgau.png', 'uploads/universities/dgu.png', 'uploads/universities/dgtu.png'],
  'kchr': ['uploads/universities/skga.png', 'uploads/universities/kchgu.png'],
  'chechnya': ['uploads/universities/chgpu.png', 'uploads/universities/ggnt.png', 'uploads/universities/chgu.png'],
  'ingushetiya': ['uploads/universities/igu.png'],
  'rso': ['uploads/universities/sogu.png', 'uploads/universities/sogma.png', 'uploads/universities/skgmi.png'],
  'kbr': ['uploads/universities/kbgau.png', 'uploads/universities/kbgu.png', 'uploads/universities/skgii.png']
};

var selected;
showInfo = function showInfo(region, cv_count, r_count, parent_class) {
  $("#title").html(region);
  $("#cv_count").html(cv_count);
  $("#r_count").html(r_count);
  var univer_list = "";
  universities[parent_class].forEach(function (element) {
  ...
  selected = parent_class;
  $("#" + parent_class).css("opacity", ".5");
  $("#" + parent_class).css("transition", ".5s"); // $("#stat_info").css("top", (e.clientY + 15) + "px")
  //$("#stat_info").css("left", (e.clientX + 15) + "px")
};

var displayTimer;

hideInfo = function hideInfo(parent_class) {
