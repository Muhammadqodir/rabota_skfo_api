        ...
        <div class="col-md-9 col-xl-9 col-sm-12" style="min-height: 500px;">
            ...
            <div class="page-section" id="1">
                ...
                <div class="formControl" style="margin-top: 10px; max-width: none;">
                    ...
                    <input type="" placeholder="Наименование вакансии" id="position" name="position">
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="formControl" style="margin-top: 10px;">
                            ...
                            <select id="tech_knowledges" name="tech_knowledges">
                                <option>Не имеет значения</option>
                                <option>Базовый уровень</option>
                                <option>Начальный</option>
                                <option>Средний пользователь</option>
...
<div class="formControl" style="height: 100%; margin-top: 0px;">
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" class="custom-control-input" id="is_for_dp">
                        ...
                        <div class="formControl" style="margin-top: 10px;">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input id="salaryFrom" onkeyup="currencyInputMask(this, event)" placeholder="50 000">
                                </div>
                                <div class="col-6">
                                    <label for="salaryTo">До:</label>
                                    <input id="salaryTo" onkeyup="currencyInputMask(this, event)" placeholder="150 000">
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="formControl" style="max-width: 100000px;">
                    ...
                    <textarea id="social_package"></textarea>
                </div>
	    </div>
            ...
            <div class="page-section" id="3">
                ...
                <div class="formControl" style="max-width: 100000px;">
                    ...
                    <textarea id="additional_requirements"></textarea>
                </div>
            </div>
<!--
...
<script>
    ...
    var vacancy_id = -1;
    contactData = new ContactData('altContacts', []);
    skillsView = new SkillsView('bonusesList', 'edBonuses', 'btnAddBonus', []);
    driverLicense = new DriverLicense('driver_license', []);
    quize = new Quize([]);
</script>
@endsection
