...
<div class="pages" style="font-family: myfont_light; margin-top: 25px; margin-bottom: 30px;">
    <div class="row no-gutters" style="width: 100%;">
        <div class="col-md-9 col-xl-9 col-sm-12" style="min-height: 500px;">
            ...
            <input id="user_id" value="{{$student->id}}" hidden>
            <div class="page-section" id="0" style="padding-top: 0px;">
                <div class="row">
                    <div class="col-lg-3 col-md-12" style="margin-top: 12px;">
                        <div style="width: 100%">
                            <img style="width: 100%; border-radius: 50px;" src="{{$student->isUserHasPic() ? asset($student->pic) : asset('res/icons/no-photo.jpeg')}}">
                            <div class="editPic">
                                <a><img src="{{asset('res/icons/edit.svg')}}" style="width: 100%;"></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="formControl" style="margin-top: 10px;">
                                    ...
                                    <input type="" placeholder="Иванов Иван Иванович" disabled value="{{$student->name}}" id="name" name="name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="formControl" style="margin-top: 10px;">
                                    <label for="burnDate" class="one_line_text">Дата рождения <span class="necessarly">*</span></label>
                                    <input type="" id="burnDate" value="{{$student->getDetails()->bday}}" disabled placeholder="06.08.2001" maxlength="10">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="formControl">
                                    ...
                                    <input type="" placeholder="Ставрополь" disabled value="{{$student->getRegionName()}}" id="city">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="formControl">
                                    ...
                                    <option value="m" {{$student->getDetails()->sex == 'm' ? 'selected':''}}>Мужской</option>
                                        <option value="f" {{$student->getDetails()->sex == 'f' ? 'selected':''}}>Женский</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="formControl">
                                    ...
                                    <input type="" id="citizenship" placeholder="" value="{{$student->getResume()->citizenship}}" maxlength="10">
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="formControl" style="margin-top: 10px;">
                                    ...
                                    <input type="" maxlength="10" placeholder="+79682659013" disabled value="{{$student->phone}}" id="phoneNum" name="name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="formControl" style="margin-top: 10px;">
                                    <label for="secondPhoneNum">Email</label>
                                    <input id="secondPhoneNum" disabled value="{{$student->email}}" placeholder="example@example.com">
                                </div>
                            </div>
                        </div>
            ...
            <div class="page-section" id="1">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="formControl" style="margin-top: 10px; max-width: none;">
                            ...
                            <input type="text" id="position" value="{{$student->getResume()->position}}">
                            <!-- <select id="position">
                                @foreach (App\Models\Position::all() as $item)
                                    <option value="{{$item->id}}" {{$student->getResume()->position == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                @endforeach
                            </select> -->
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="formControl" style="max-width: none;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input id="salary" value="{{$student->getResume()->salary}}" placeholder="50 000" onkeyup="currencyInputMask(this, event)">
                                </div>
                                <div class="col-md-6" style="margin-top: 8px;">
                                    <div class="custom-control custom-checkbox mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" {{$student->getResume()->salary_by_agreement == 1 ? 'checked' : ''}} id="salary_by_agreement">
                ...
                <div class="formControl" style="max-width: 100000px;">
                    ...
                    <select onchange="" id="employment_type">
                        <option value="0" {{$student->getResume()->employment_type == 0 ? 'selected' : ''}}>Полный рабочий день</option>
                        <option value="1" {{$student->getResume()->employment_type == 1 ? 'selected' : ''}}>Неполный рабочий день</option>
                        <option value="2" {{$student->getResume()->employment_type == 2 ? 'selected' : ''}}>Удаленная работа (фриланс)</option>
                        <option value="3" {{$student->getResume()->employment_type == 3 ? 'selected' : ''}}>Посменный график</option>
                        <option value="4" {{$student->getResume()->employment_type == 4 ? 'selected' : ''}}>Временная работа</option>
                    </select>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox mr-sm-2">
                            <input type="checkbox" {{$student->getResume()->b_trip == 1 ? 'checked' : ''}} class="custom-control-input" id="b_trip">
                            <label class="custom-control-label" for="b_trip">Готов к командировкам</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox mr-sm-2">
                            <input type="checkbox" class="custom-control-input" {{$student->getResume()->moving == 1 ? 'checked' : ''}} id="moving">
            ...
            <div class="page-section" id="6">
                ...
                <div class="formControl" style="max-width: 10000px;margin-top: 10px;">
                    <textarea placeholder="-Играю на гитаре&#10;-Шахматы&#10;-Программирование" style="height: 50px;" id="interests">{{$student->getResume()->interests}}</textarea>
                </div>
            </div>
            <div class="page-section" id="7">
                ...
                <div class="formControl" style="max-width: 10000px;margin-top: 10px;">
                    <textarea placeholder="Мои сильные стороны — хорошие управленческие и лидерские навыки, клиентоориентированность, системное мышление, позитивный настрой. Не пью, не курю." style="height: 50px;" id="additional_info">{{$student->getResume()->additional_info}}</textarea>
                </div>
            </div>
...
<script>
    ...
    var resume_route = window.location.href;
    contactData = new ContactData('altContacts', @json($student->getResume()->getContacts()));
    skillsView = new SkillsView('skillsList', 'edSkill', 'btnAddSkill', @json($student->getResume()->getSkills()));
    langsView = new LangsView('langItems', 'addLangBtn', @json($student->getResume()->getLangs()));
    eduView = new EducationView('educationItems', @json($student->getResume()->getEducation()));
    expView = new ExpView('experienceItems', @json($student->getResume()->getExperience()));
    achievementView = new AchievementsView('achievementsItems', @json($student->getResume()->getAchievements()));
    driverLicense = new DriverLicense('driver_license', @json($student->getResume()->getDL()));
</script>
@endsection
